...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.ico', 'favicon-16x16.png', 'favicon-32x32.png', 'icon-192.png', 'icon-512.png', 'apple-touch-icon.png'],
      manifest: {
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Supabase Storage (images, documents) - Cache First strategy
