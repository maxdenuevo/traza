...
export const PendientesPage = () => {
  ...
  // Fetch data
  const { data: areasPendientes = [], isLoading } = usePendientesByArea(currentProject?.id || '');
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-esant-gray-600">Organizado por áreas</p>
      ...
      {areasPendientes.map(({ area, pendientes }) => {
